...
<head>
  ...
  <title><%=TituloPagina%> - Ranking de Grupos</title>
...
%>
      ...
      <td><a href='apostasGrupos.asp?codJogo=<%=rs("cod_Jogo")%>&codGrupo=<%=request("cmbAtualizar")%>'><%=rs("cod_Jogo")%>.</a></td>
...
%>
  ...
  <table class="Bolao" width="70%" border="0" cellspacing="2" cellpadding="2" align="center">
    ...
    <tr>
      ...
      <th colspan="5" height="24">VISUALIZA&Ccedil;&Atilde;O DE GRUPOS | GRUPO SELECIONADO
    ...
    <tr>
      ...
      <th colspan="2" >RESPONS&Aacute;VEL PELO GRUPO :
