				...
				if rs7("placar_A") = rs7("r_placar_A") and rs7("placar_B") = rs7("r_placar_B") then 'Placar Certo
					pontuacao = 10
						...
						if rs7("placar_A") = rs7("r_placar_A") then 'Acertou Escore do Vencedor
                            ...
                            'Atribuindo peso ponderado aos jogos das SEMI-FINAIS E FINAIS | Incluído para a versão de 2013

	                         if codJogo >= 13 AND codJogo <= 15 then 'Peso 2 para os Jogos das Semi-Finais e Disputa de Terceiro Lugar
                                    pontuacao = pontuacao * 2
			         else if codJogo >= 16 then 'Peso 3 para o Jogo da Grande Final
