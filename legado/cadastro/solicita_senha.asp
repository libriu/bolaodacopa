...
'         ConnStrMySQL  = "Driver={MySQL ODBC 3.51 Driver};Server=localhost;Database=bolaodacopa2013;uid=bolaodacopa;pwd=Brasil;option=3"
    ...
    if rs.eof then
      ...
      if rs("email") = "." then
       ...
       Dim strResultado
       strResultado = EnviaEmail("Bolao da Copa do Mundo 2014", "bolaodacopa@bolaodacopa.unositehospedagem.com.br", request("login"), rs("email"), "", "", "TEXTO", "Bolao da Copa do Mundo 2014 - Senha", request("login") & ", sua senha é " & rs("senha_apostador"))
