...
<%  end if
     ...
     if now() >= cdate(rs("data_jogo")) then%> 'O servidor modificou o padrão de data para DD/MM/AAAA | 2014
...
<table class="Bolao" width="80%" border="0" cellspacing="2" cellpadding="2" align="center">
  <tr>
    <th colspan="9" height="24">MURAL DE MENSAGENS (ÚLTIMAS 20 MENSAGENS)</th>
  </tr>
  <tr>
...
<%
	  ...
	  sql = sql & " ORDER BY Mensagens.cod_Mensagem DESC LIMIT 20"
