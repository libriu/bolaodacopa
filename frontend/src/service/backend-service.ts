...
import { DadosLoginInterface, DadosApostaInterface, DadosAtualizarApostaInterface, DadosEnviarMensagemInterface, DadosAlterarSenhaInterface } from './interfaces';
