              ...
              child: ListView(
                  children: [
                    ...
                    const SizedBox(
                        width: 400,
                        height: 90,
                        child: Text("OBS: Será descontado o valor de R\$ 3000,00 da arrecadação total do bolão a fim de custear as despesas operacionais de hospedagem.",textAlign: TextAlign.justify, style: TextStyle(fontSize: 15),)
                    ),
                    const SizedBox(
                        width: 400,
                        height: 50,
